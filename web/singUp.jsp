        ...
        <div class="container-fluid">
            ...
            <div class="col-md-6 col-xs-12">
                ...
                <div class="panel panel-info">
                    <div class="panel-heading" style="text-align: center"><strong>Administrative Registration Form : </strong></div>
                    <div class="panel-body">
                        <form  class="form-horizontal" method="POST" action="save.htm">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-10">
                                    <input  type="text" name="email" class="form-control" id="passField" placeholder="Enter Your Email" required="true"/>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="col-xs-10 col-xs-offset-2">
                                <button type="submit" class="btn btn-primary glyphicon glyphicon-log-in">&nbsp;SingUp </button> 
                            </div>
                        </form>
                    </div>
